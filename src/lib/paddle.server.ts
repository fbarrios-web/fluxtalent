...
/** Maps a Paddle price external_id back to the internal plan tier + ARS-equivalent price. */
export function planFromPriceId(priceId: string): { plan: 'starter' | 'pro' | 'enterprise'; priceArs: number } | null {
  switch (priceId) {
    case 'starter_monthly_usd': return { plan: 'starter', priceArs: 24000 };
    case 'pro_monthly_usd':     return { plan: 'pro',     priceArs: 48000 };
    case 'enterprise_monthly_usd': return { plan: 'enterprise', priceArs: 96000 };
    default: return null;
  }
}
